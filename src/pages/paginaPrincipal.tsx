...
const PaginaPrincipal = () => {
    ...
    return (
        <section className="bg-black/80   h-full">
            <section className="p-7 lg:w-[60%] m-auto">
                <h1 className="font-bold w-full text-lg mt-8 lg:mt-28 text-center uppercase lg:text-3xl text-violet-500">Gerador de senhas seguras</h1>
                <section className="flex mt-10 flex-col lg:flex-row gap-6 lg:justify-center lg:items-center">
                    ...
                    <div className=" flex gap-1 w-full items-center justify-center lg:w-24">
                        <button id="copy" type="button" onClick={(e) => copyPassword(e)} className="text-gray-800 hover:text-violet-500">
                        ...
                        <button id="renew" type="button" onClick={generatePassword} className="text-gray-800 hover:text-violet-500">
                            <Icon fontSize="large" component={AutorenewOutlined} />
                        </button>
                    </div>
                </section>
                <div className="py-9 lg:py-16">
                    <Divider className="font-bold uppercase text-lg lg:text-3xl text-violet-500">Personalizar</Divider>
                </div>
                <section className="flex flex-col items-center w-full lg:justify-center">
                    <div className="w-full flex flex-col items-center gap-2">
                        <span className="text-violet-500">Tamanho: {size}</span>
                    ...
                    <div className="w-full my-10">
                        <ul className="flex gap-6 lg:gap-1 items-center justify-center lg:justify-center lg:items-start flex-wrap ">
                            <li className="text-violet-500 flex flex-col items-center justify-center lg:flex-row">
                            ...
                            <li className="text-violet-500 flex flex-col items-center justify-center lg:flex-row ">
                                <Checkbox className="" checked={numeros} onChange={() => setNumeros(!numeros)} />
                                <span>Números</span>
                            </li>
                        </ul>
                    </div>
